        <div id="cajaaa">
            <div id="detalle_producto" class="col-12 row m-0 container-fluid p-0">
                ...
                <div id="imagenes_productos" class="col-6 row m-0">
                    <div id="imagen_principal" class="col-12 p-2" style="height: 600px;">
                        <img style="padding: 70px;" src="https://m.media-amazon.com/images/I/71ctRE34RuL._AC_SX466_.jpg"
                ...
                <div id="detalles" class="col-6 p-2" style="height: 750px;width:745px;">
                    ...
                    <div id="datoss" style="margin-top: 20px;">
                        <div class="inf">
                            ...
                            <p><b>Laptop HP Vicrus 15-FB0103LA RYZEN5 5600H FHD <br> 8GB 512GB
                                    SSD 15.6- RTX 3050 4GB Windows 11 </b><br><br>Precio
                                <b>S/ 3,359.00 </b>
                            </p>
                        </div>
                        <div class="inf">
                        ...
                        <div class="inf">
                            <p><b>Caracteristicas destacadas</b><br>
                                Vendido por: Novatec <br>
                                Disponibilidad: en existencia <br>
                            ...
                            <div class="accordion-body">
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><b>Vendido y despachado por</b></td>
                                            <td>NOVATEC</td>
                                        </tr>
                                        <tr>
                                            <td><b>Modelo</b></td>
                                        ...
                                        <tr>
                                            <td><b>Tipo de RAM</b></td>
                                            <td>LPDDR5-5500</td>
                                        </tr>
                                        <tr>
                                            <td><b>Unidad óptica</b></td>
                                            <td>No</td>
                                        </tr>
                                        <tr>
                                            <td><b>Modelo de procesador</b></td>
                                            <td>AMD Ryzen™ 3 7320U</td>
                                        </tr>
                                        <tr>
                                            <td><b>Modelo de tarjeta de video</b></td>
                                        ...
                                        <tr>
                                            <td><b>Entrada de audio</b></td>
                                            <td>1x Headphone / microphone combo jack (3.5mm)</td>
                                        </tr>
                                        <tr>
                                            <td><b>Lector tarjeta SIM</b></td>
                                            <td>No</td>
                                        </tr>
                                        <tr>
                                            <td><b>Lector tarjeta SD</b></td>
                                            <td>Sí</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><b>Procesador de cómputo</b></td>
                                            <td>AMD Ryzen 3</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><b>Procesador y generación</b></td>
                                            <td>AMD Ryzen™ 3 7320U</td>
                                        </tr>
                                        <tr>
                                            <td><b>Teclado Iluminado</b></td>
                                            <td>No</td>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <h4 style="display: flex;justify-content: center;" class="text-center">Productos Similares</h4>
            <div id="productos_similares" class="col-12 row p-2 m-0">

                <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                    <div class="card" style="min-height: 700px;">
                        <a href="detalle.html"><img
                                src="https://plazavea.vteximg.com.br/arquivos/ids/29227295-1000-1000/20394528.jpg?v=638567137253600000"
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                    <div class="card" style="min-height: 700px;">
                        <a href="detalle.html"><img
                                src="https://plazavea.vteximg.com.br/arquivos/ids/25699586-512-512/20254058.jpg"
                                class="card-img-top w-100" alt="..." style="height: 400px;"></a>
                        <div class="card-body">
                            <h5 class="card-title">HP</h5>
                            <div class="overflow-y-hidden" style="height: 190px;">
                                <p class="card-text">Laptop HP 15.6" Intel Core i5 13a Gen 10 Núcleos 8GB 512GB
                                    15-FD0007LA
                                    <br><br>
                                    S/ 1,899.00
                                </p>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                    <div class="card" style="min-height: 700px;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">HP</h5>
                            <div class="overflow-y-hidden" style="height: 190px;">
                                <p class="card-text">Laptop HP 245 G7, 14″ AMD Athlon Silver 3050U, 2.3GHz, 4GB DDR4,
                                    500GB
                                    SATA, W10 Home <br><br>
                                    S/1,922.00
                                </p>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 p-2">
                    <div class="card" style="min-height: 700px;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">HP</h5>
                            <div class="overflow-y-hidden" style="height: 190px;">
                                <p class="card-text">LAPTOP HP INTEL CORE I5-1335U 13va Generación 156” FHD 8GB RAM
                                    512GB
